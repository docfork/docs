...
AI coding assistants (Claude 3.7, GPT-4o) are powerful, but they suffer from a critical flaw: **The Knowledge Cutoff.**
...
2. **We Fetch:** Docfork searches the official documentation in < 500ms.
...
<Cards>
  <Card
    ...
    description="Optimized for speed. Our p95 retrieval time is ~500ms, ensuring your flow state is never broken."
  />
  <Card
  ...
  <Card
    ...
    description="From React to Rust, if it has public docs, we likely index it. If not, you can request it."
    href="/search"
  />
  <Card
    title="🧠 AI Optimized"
...
<Cards>
  ...
  <Card
    title="Rules"
    href="/context/rules"
    description="Automate Docfork with .cursorrules."
  />
  <Card
    title="Cabinets"
    href="/core/cabinets"
